...
$sqlAluno = "SELECT id, nome, matricula 
             FROM usuarios 
...
// Buscar média final e status
$sqlNotas = "
    SELECT nota_final, status, data_registro
    FROM notas
...
<div class="container">
  ...
  <div class="card" style="max-width: 900px; margin: 0 auto;">
      ...
      <h2 style="margin-top: 0;">
        Média Final — <?= htmlspecialchars($aluno['nome']) ?> 
      ...
      <table class="table" style="width:100%; border-collapse:collapse; margin-top:20px;">
          <thead>
              <tr>
                  ...
                  <th style="padding:8px; text-align:center;">Data Registro</th>
              </tr>
          </thead>
          ...
          <?php if (count($notas) === 0): ?>
              <tr>
                  <td colspan="3" style="text-align:center; padding:20px;">
                      Nenhuma média final cadastrada.
                  </td>
              </tr>
          <?php else: ?>
              <?php foreach ($notas as $n): ?>
                  <tr style="border-top:1px solid #ccc;">
                      ...
                      <td style="padding:8px; text-align:center;">
                          <?= date("d/m/Y H:i", strtotime($n['data_registro'])) ?>
                      </td>
                  </tr>
              <?php endforeach; ?>
          <?php endif; ?>
